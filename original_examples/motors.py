# Xiao RP2040 servo demo
# Hardware setup:
#   Servo on D6 with external 5V power supply
#   Button on D1 and ground
...
# Servo setup
#Servo Connector in Expansion Board is pin D6, same as TX UART
pwm_servo = pwmio.PWMOut(board.D6, duty_cycle=2 ** 15, frequency=50)
servo1 = servo.Servo(
